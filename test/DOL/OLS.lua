...
function removeObseleteWeights(Q, s, e)
  print("removeObseleteWeights", Q, s, e)
  for i = #Q, 1, -1 do
...
-- hasImprovement(w, V_PI, S, VToPoints)
...
while #Q ~= 0 do
  ...
  if not isIncluded(S, V_PI) and hasImprovement(w, V_PI, S, VToPoints) then
      ...
      for i = 1, #W_V_PI do
          ...
          print("cornerWeight", cornerWeight)
          cornerWeight[2] = estimateImprovement(cornerWeight[1], S, VToPoints)
          print("cornerWeight[2]", cornerWeight[2])
