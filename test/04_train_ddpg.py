...
TEST_ITERS = 1000
LEARNING_ITER = 10
# LEARNING_RATE, GAMMA, BATCH_SIZE, REPLAY_SIZE, TAU, LEARNING_ITER
...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--name", default="test", help="Name of the run")
    ...
    agent = ddpgModel.AgentDDPG(act_net, device=device)
    ...
    with ptan.common.utils.RewardTracker(writer) as tracker:
        with ptan.common.utils.TBMeanTracker(writer, batch_size=10) as tb_tracker:
            while True:
                ...
                last_act_v = tgt_act_net.target_ddpgModel(last_states_v)
                q_last_v = tgt_crt_net.target_ddpgModel(last_states_v, last_act_v)
