...
class HetNetEnergyEnv(gym.Env) :
    ...
    def getWeightObj1(self, w):
        ...
        #return (1- (self.sim.calEnergyConsumption()/maxPower))
    ...
    def setActionSpace(self, _wEdges, actionSpace):
        ...
        #    actions.append(math.pow(2, wEdge))

        #actions = (_wEdges + 1)
        #scale = math.sqrt(actionSpace[1])
        #actions = scale ** actions
        actions = actions
        #actions = np.clip(actions, actionSpace[0], actionSpace[1])
        return actions
